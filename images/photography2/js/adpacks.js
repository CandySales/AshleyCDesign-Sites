jQuery(function($){
	...
	var adpacksstyles = {
		...
		#adpack-remove{background:url(http://tympanus.net/codrops/adpacks/adclose_black.png) no-repeat center center;}\
	    ',
		lightVerticalBottomLeft	: '\
		#codrops-ad-wrapper{color:#000;left:10px;bottom:30px;background:transparent url(http://tympanus.net/codrops/adpacks/bg_ad_light.png) repeat top left;}\
		#codrops-ad-wrapper .one .bsa_it_ad a{color:#000;}\
		#adpack-remove{background:url(http://tympanus.net/codrops/adpacks/adclose_black.png) no-repeat center center;}\
	    ',
		darkHorizontal	: '\
		...
		#codrops-ad-wrapper .adhere {width: 130px;height: 100px;display: block;background: rgba(255, 255, 255, 0.5);margin: 15px 0px 24px 26px;box-shadow: 1px 1px 2px rgba(0,0,0,0.3);line-height: 100px;text-align: center;font-size: 11px;font-family: Arial;font-style: italic;color: #333;text-shadow: 1px 0px 1px rgba(255,255,255,0.6);}\
